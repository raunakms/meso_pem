...
### Define Files -----
file.dat <- file.path(dir.data, "meso_cnv_seg_values_calls.tsv")
file.refseq <- file.path(dir.data, "refseq_gene_table.tsv")
...
colnames(dat) <- des$Gene
dat <- t(dat)

### Write Table ----
file.dat <- file.path(dir.data, "meso_cnv_seg_values_calls_transformed.tsv")
...
### Write Table ----
file.dat <- file.path(dir.data, "meso_cnv_seg_values_calls_transformed2.tsv")
