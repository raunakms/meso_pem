...
### GENES ---
genes.sig <- c("BAP1","CD274","PDCD1LG2","PDCD1","CD80","CD86","CD28","CTLA4","ICOSLG","ICOS","TNFRSF14","BTLA","HLA-A","HLA-B","HLA-C","LAG3","LGALS9","HAVCR2")
...
file.plot01 <- file.path(dir.plot, "heatmap_ImmuneCheckpointM_mRNA_revised_withBAP1.pdf")
