...
p <- get.boxplot(df=dm, plotitle="DNA_Repair", nrow=2, ncol=11)

file.plot <- file.path(dir.plot, "boxplot_protein_DNARepair.pdf")
...
df <- get.wilcox.rank.test(expr.sig, class1=grp0, class2=grp1)
dm <- dataByGroup(expr, df)
p <- get.boxplot(df=dm, plotitle="Chromatin_Remodeling", nrow=1, ncol=11)

file.plot <- file.path(dir.plot, "boxplot_protein_ChromatinRemodeling.pdf")
...
file.plot <- file.path(dir.plot, "boxplot_protein_MAPKSignaling.pdf")
pdf(file.plot, height=2, width=6.8)
	grid.arrange(p, ncol=1, nrow=1)
dev.off()
...
file.plot <- file.path(dir.plot, "boxplot_protein_PI3KSignaling.pdf")
...
file.plot <- file.path(dir.plot, "boxplot_protein_TORSignaling.pdf")
pdf(file.plot, height=2, width=4)
	grid.arrange(p, ncol=1, nrow=1)
dev.off()
...
file.plot <- file.path(dir.plot, "boxplot_protein_Uncategorized.pdf")
pdf(file.plot, height=2, width=6.8)
	grid.arrange(p, ncol=1, nrow=1)
dev.off()
