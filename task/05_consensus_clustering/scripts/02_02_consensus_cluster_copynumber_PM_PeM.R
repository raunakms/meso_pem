...
dir.cnv <- file.path("/Data/Raunak/projects/MESO_peritoneal/task/08_compare_cnv/data")

#### DEFINE FILE ------------------------------------------------------
file.dat <- file.path(dir.cnv, "cnv_meso_pem_pm_seg_mean_combined.tsv.gz")
...
### Consensus Cluster ---------------------------------------------------
dir.batch <- file.path(dir.plot, "02_02_MESO_consensus_cluster_cnv_PM_PeM")
...
write.table(dclass, file.path(dir.plot, "02_02_MESO_consensus_cluster_cnv_PM_PeM/02_02_MESO_consensus_cluster_cnv_PM_PeM.tsv"), sep="\t", row.names=F, col.names=T, quote=F)
...
### CALL FUNCTION ---
file.plot <- file.path(dir.plot, "meso_dendogram_cnv.pdf")
