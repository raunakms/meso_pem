...
### DEFINE ENVIRONMENT -------------------------------------------------------------------------------------
batch <- "MESO_OUTLIERS_protein_p03"
...
write.table(mat, file.path(dir.data, "MESO_OUTLIERS_protein_p03_pathway_enrichment_reactome.tsv"), sep="\t", row.names=T, col.names=NA, quote=F)


### RELOAD DATA ----
file.mat <- file.path(dir.data, "MESO_OUTLIERS_protein_pathway_enrichment_reactome.tsv")
...
file.plot <- file.path(dir.plot, "MESO_OUTLIERS_protein_pathway_enrichment_heatmap_reactome.pdf")
